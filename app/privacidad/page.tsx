    ...
    <section className="py-20 px-8 bg-te-bg min-h-screen">
      <div className="max-w-[680px] mx-auto w-full flex flex-col items-start gap-8">
        ...
        <div className="flex flex-col gap-3">
          <h1 className="font-display font-semibold text-[32px] md:text-[40px] leading-tight text-te-text tracking-tight">
        ...
        <hr className="w-full border-t border-te-glass-border" />
